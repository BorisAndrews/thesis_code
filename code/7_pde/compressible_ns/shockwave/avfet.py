...
Re = Constant(2**4)  # Reynolds number
...
pvd = VTKFile("output/7_pde/compressible_ns/shockwave/avfet/solution.pvd")
...
# Create text files
mass_txt            = "output/7_pde/compressible_ns/shockwave/avfet/mass.txt"
momentum_txt        = "output/7_pde/compressible_ns/shockwave/avfet/momentum.txt"
kinetic_energy_txt  = "output/7_pde/compressible_ns/shockwave/avfet/kinetic_energy.txt"
internal_energy_txt = "output/7_pde/compressible_ns/shockwave/avfet/internal_energy.txt"
energy_txt          = "output/7_pde/compressible_ns/shockwave/avfet/energy.txt"
entropy_txt         = "output/7_pde/compressible_ns/shockwave/avfet/entropy.txt"
