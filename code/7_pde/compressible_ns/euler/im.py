...
pvd = VTKFile("output/7_pde/compressible_ns/euler/im/solution.pvd")
...
# Create text files
mass_txt            = "output/7_pde/compressible_ns/euler/im/mass.txt"
momentum_txt        = "output/7_pde/compressible_ns/euler/im/momentum.txt"
kinetic_energy_txt  = "output/7_pde/compressible_ns/euler/im/kinetic_energy.txt"
internal_energy_txt = "output/7_pde/compressible_ns/euler/im/internal_energy.txt"
energy_txt          = "output/7_pde/compressible_ns/euler/im/energy.txt"
entropy_txt         = "output/7_pde/compressible_ns/euler/im/entropy.txt"
